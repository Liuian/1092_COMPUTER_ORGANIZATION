 ...
 ** Parameter address is memory address in hexadecimal.
 *******************************************************/
 ...
 ** Parameter address_to_deci is memory address in decimal.
 ** Parameter tag_length is the bit number of tag.
 **********************************************************/
 ...
 ** Parameter address_to_deci is memory address in decimal.
 ** Parameter tag_length is the bit number of tag.
 ** Parameter index_length is the bit number of index.
 **********************************************************/
 ...
 ** Parameter cache_index is the array in row of index.
 ** Parameter address_tag is the new tag will replace the older one.
 ** Parameter words is the number of block in corresponding set.
 *******************************************************************/
 ...
 ** Parameter address_tag is the new tag will replace the older one.
 ** Parameter words is the number of block in corresponding set.
 ** Parameter visit_index is the block that is hit or victim(visit_index=0).
 *************************************************************************/
 ...
 ** Parameter cache_index is the array in row of index.
 ** Parameter address_tag is the new tag that will be searched in cache.
 ** Parameter words is the number of block in corresponding set.
 ** Parameter replace_algorithm determines which algorithm will be used 
 ** when there exists victim. 
 ***********************************************************************/
...
int main(int argc, char *argv[]){
    ...
    {   
        row = (int)(cache_size * 1024 / block_size);
        column = 1;
    ...
    {
        row = (int)(cache_size * 256 / block_size);
        column = 4;
